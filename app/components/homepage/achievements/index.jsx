                        ...
                        >
                            ...
                            {achievements.length > 1 && (
                                <button
                                    ...
                                    className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 p-2 sm:p-3 rounded-full text-white hover:text-[#16f2b3] transition-all z-10 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
                                    aria-label="Previous"
                                >
                            ...
                            {achievements.length > 1 && (
                                <button
                                    ...
                                    className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 p-2 sm:p-3 rounded-full text-white hover:text-[#16f2b3] transition-all z-10 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
                                    aria-label="Next"
                                >
