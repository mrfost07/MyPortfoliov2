...
# [Built Portfolio With GitHub ](https://github.com/mrfost07/MyPortfolio.git)
...
## View live preview [here](https://fostportfolio.netlify.app/).
...
### Then, Customize data in the `utils/data` [folder](https://github.com/mrfost07/MyPortfoliov2/tree/main/utils).
